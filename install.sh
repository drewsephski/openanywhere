...
main() {
  ...
  echo ""
  echo -e "  This will show a QR code. ${BOLD}First:${NC} install Tailscale"
  echo -e "  on your phone (App Store → Tailscale → log in with"
  echo -e "  the SAME account). Then scan the QR code."
  echo ""
